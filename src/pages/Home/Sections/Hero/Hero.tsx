	...
	return (
		<section className="relative">
			...
			lg:right-[165px]">
				...
				bg-linear-to-t from-white/5 to-black
			...
			<div className="absolute w-full h-full z-0">
				<img src={oval} alt="oval in the background" className="absolute right-[-60px] top-[480px]" />
				<img src={lines} alt="lines in the background" className="absolute min-w-[530px] min-h-[130px] -left-100 top-30" />
			</div>
			<div
				className="
